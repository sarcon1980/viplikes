<template>
    <admin-layout>
        ...
        <!--            <tr>-->
        <!--                <td>{{ item.id }}</td>-->
        <!--                <td v-html="showStatus(item.is_active)"></td>-->
        <!--                <td>{{ item.type }}</td>-->
        <!--                <td>{{ item.count }}</td>-->
        <!--                <td>{{ item.price }}</td>-->
        <!--                <td>{{ item.price_for_sale }}</td>-->
        <!--                <td>{{ item.discount }}</td>-->
        <!--                <td>{{ item.created_at }}</td>-->
        <!--                <td class="text-right">-->
        <!--                    <button class="btn btn-info" @click="editModal(item)">-->
        <!--                        <i class="fa fa-edit"></i>-->
        <!--                    </button>-->
        <!--                </td>-->
        <!--            </tr>-->
                                    ...
                                    <div class="row">
                                        <div class=" col-4">
                                            <div class="form-group">
                                                <label for="name" class="">Количество</label>
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" placeholder="count"
                                                           v-model="form.count"
                                                           :class="{ 'is-invalid' : form.errors.count }"
                                                           autofocus="autofocus" autocomplete="off"
                                                    >
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">{{ titleItem }}</span>
                                                    </div>
                                                    <div class="invalid-feedback mb-3"
                                                         :class="{ 'd-block' : form.errors.count}">
                                                        {{ form.errors.count }}
                                                    </div>
                                                </div>
                                            </div>
...
export default {
    ...
    computed: {
        formTitle() {
            return this.editedIndex === -1 ? 'Добавление продукта' : 'Редактирование продукта';
        },
        buttonTxt() {
